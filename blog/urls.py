...
from .views import (PostListView, PostDetailView, AuthorView, AllCategoriesListView, CategoryPostListView, CreatePostView, PostUpdateView, PostDeleteView, SearchResultsView, api_PostListView)
...
urlpatterns = [
    ...
    path('', api_PostListView, name='post_list'),
]